...
mutable struct Mumps{Tv <: MUMPSValueDataType}
  ...
  function Mumps{Tv}(
    ...
    if Tv == Float32
      id = @mumps_call(
        :mumps_initialize_float,
        Ptr{Nothing},
        (Int32, Ptr{Int32}, Ptr{Float32}),
        sym,
        icntl,
        cntl
      )
    ...
    elseif Tv == Float64
      id = @mumps_call(
        :mumps_initialize_double,
        Ptr{Nothing},
        (Int32, Ptr{Int32}, Ptr{Float64}),
        sym,
        icntl,
        cntl
      )
    ...
    elseif Tv == ComplexF32
      id = @mumps_call(
        :mumps_initialize_float_complex,
        Ptr{Nothing},
        (Int32, Ptr{Int32}, Ptr{Float32}),
        sym,
        icntl,
      ...
      id = @mumps_call(
        :mumps_initialize_double_complex,
        Ptr{Nothing},
        (Int32, Ptr{Int32}, Ptr{Float64}),
        sym,
        icntl,
